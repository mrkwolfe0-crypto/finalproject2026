...
"""
"""
The new line \n can be before or after, the position is based on the preference of the coder. 
"""
print("\nAbility Modifiers")
...
"""
Weapon stats can be populated by replicating how I did the armor bonuses.
"""
"""def Armor():
    Armor_types = { 
        "No Armor" : ["No Armor"],
...
def Armor():
    ...
    return all_armor
"""The method I am using takes all the content from the buckets and pri ts them. Using the item() method I will get a print out that will show the container or in this case the category the armor falls into. Also applicable to the weapon list."""
